...
```{r}
# the big dataset
skaters <- read_csv("C:/Users/jaker/Downloads/Hockey Data/skaters/skaters_2008_to_2024.csv")
skaters <- skaters |> filter(situation == "all") |> arrange(name, season) |> 
  filter(position != "D")
skaters25 <- read_csv("C:/Users/jaker/Downloads/Hockey Data/skaters/25-26skaters.csv")
```
